...
class NewsViewModel(
    ...
    private suspend fun safeSearchNewsCall(searchQuery: String){
        ...
        try {
            ...
            when(t) {
                is okio.IOException -> searchNews.postValue(Resource.Error("NETWORK ERROR"))
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String){
        ...
        try {
            ...
            when(t) {
                is okio.IOException -> breakingNews.postValue(Resource.Error("NETWORK ERROR"))
    ...
    private fun hasInternetConnection(): Boolean {
        ...
        if(Build.VERSION.SDK_INT>= Build.VERSION_CODES.M) {
            ...
            connecticityManager.activeNetworkInfo?.run {
                return when(type) {
                    TYPE_WIFI -> true
                    TYPE_MOBILE -> true
                    TYPE_ETHERNET -> true
